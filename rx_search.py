...
def query_openfda(brand_name):
    ...
    url = "https://api.fda.gov/drug/label.json?search=openfda.brand_name:\"{brand_name}\""
    ...
    if response.status_code == 200:
        ...
        med_results = []
        # loop over response to get brand, generic, and unii code, and store results
        ...
        return med_results
    # return an empty list if no match or error
    return []